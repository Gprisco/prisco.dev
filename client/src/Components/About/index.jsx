          ...
          <div className="row">
            <div className="col">
              <p className="mt-3 about">
                ...
                <br />
                <br />
                Computer programming has always been a passion for me and
                whether it regards developing a simple mobile application or
                building a complex system, I <b>thoroughly enjoy</b> doing so.
                <br />
                <br />
                ...
                fell in love with my experience at the Apple Developer Academy
                in Naples.
                <br />
                <br />
                ...
                Salerno and I'm for the second year at Apple Developer Academy
                in Naples as a <b>Pier Student</b> and <b>backend developer</b>.
                <br />
                <br />
                When I'm not working alongside clients, I'm{" "}
                <b>constantly learning</b> new things, whether it is for the
                University or for some personal projects. As a matter of fact,
                I'm always trying to expand my tool-belt. Currently I'm diving
                deeper in the AI world and I recently got the{" "}
